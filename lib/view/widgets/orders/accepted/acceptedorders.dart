...
import 'package:admin/view/widgets/settingdivider.dart';
...
class AcceptedOrdersCard extends GetView<AcceptedOrdersController> {
  ...
  const AcceptedOrdersCard({Key? key, required this.orderslistmodel})
      : super(key: key);
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "admin Price:${orderslistmodel.ordersPricedelivery!}",
            style: const TextStyle(
                fontSize: 15, fontWeight: FontWeight.bold, color: Colors.grey),
          ),
          Text(
              ...
              MaterialButton(
                onPressed: () {
                  controller.doneOrders(
                      orderslistmodel.ordersId!,
                      orderslistmodel.ordersUserid!,
                      orderslistmodel.ordersType!);
                },
                color: AppColor.favoritecolor,
                child: const Text(
                  "Done",
